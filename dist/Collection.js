import { Entry, EntryNotFound } from "./Entry.js";
import { Unauthorized } from "./marcsync.js";
export class Collection {
     ...
     *
     **/
    constructor(accessToken, collectionName) {
    ...
    */
    ...
    async getEntries(filter) {
        try {
            ...
            if (!json.success)
                throw new Error();
            return json.entries.map((entry) => new Entry(this._accessToken, this._collectionName, entry));
        }
        catch (e) {
            if (e instanceof Unauthorized)
                throw new Unauthorized();
    ...
    */
     ...
     *
    */
    async updateEntries(filter, data) {
        try {
            const result = await fetch(`https://api.marcsync.dev/v1/entries/${this._collectionName}`, {
                method: "PUT",
                headers: {
...
export class CollectionNotFound extends Error {
    constructor(message = "Failed to fetch collection") {
        super(message);
    }
}
